	...
	<div class="sidebar__main">
		<nav class="menu">
			...
			<div class="menu__group">
				...
				<div class="menu__list" data-spoiler="menu">
					<div class="menu__item" data-spoiler-item>
						<a class="menu__link" href="{{ route('admin.pages.index') }}"><i class="fa-light fa-file"></i>Страницы</a>
					</div>
					<div class="menu__item" data-spoiler-item>
						<a class="menu__link" href="{{ route('admin.menu.index') }}"><i class="fa-light fa-list-tree"></i>Конструктор меню</a>
					</div>
				</div>
			</div>
			<div class="menu__group">
				...
				<div class="menu__list" data-spoiler="menu">
					<div class="menu__item" data-spoiler-item>
						<a class="menu__link" href="{{ route('admin.admins.index') }}"><i class="fa-light fa-user-tie"></i>Администраторы</a>
					</div>
					<div class="menu__item" data-spoiler-item>
						<a class="menu__link" href="{{ route('admin.roles.index') }}"><i class="fa-light fa-user-lock"></i>Роли</a>
					</div>
				</div>
			</div>
		</nav>
